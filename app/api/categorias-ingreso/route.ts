...
export async function POST(request: NextRequest) {
  try {
    ...
    console.error('Error creating categoria_ingreso:', error)
    return NextResponse.json(
...
export async function PUT(request: NextRequest) {
  try {
    ...
    console.error('Error updating categoria_ingreso:', error)
    return NextResponse.json(
...
export async function DELETE(request: NextRequest) {
  try {
    ...
    console.error('Error deleting categoria_ingreso:', error)
    return NextResponse.json(
